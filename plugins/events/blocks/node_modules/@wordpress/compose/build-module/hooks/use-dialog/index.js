...
function useDialog(options) {
  ...
  var closeOnEscapeRef = useCallbackRef(function (node) {
    if (!node) {
      return;
    }
  ...
  return [mergeRefs([constrainedTabbingRef, focusReturnRef, focusOnMountRef, closeOnEscapeRef]), _objectSpread(_objectSpread({}, focusOutsideProps), {}, {
    tabIndex: '-1'
  })];
}
