...
var _useCallbackRef = _interopRequireDefault(require("../use-callback-ref"));
...
function useDialog(options) {
  ...
  var closeOnEscapeRef = (0, _useCallbackRef.default)(function (node) {
    if (!node) {
      return;
    }
  ...
  return [(0, _reactMergeRefs.default)([constrainedTabbingRef, focusReturnRef, focusOnMountRef, closeOnEscapeRef]), _objectSpread(_objectSpread({}, focusOutsideProps), {}, {
    tabIndex: '-1'
  })];
}
