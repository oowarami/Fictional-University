...
import { BottomSheet, BottomSheetConsumer, InserterButton, getClipboard } from '@wordpress/components';
/**
  ...
  _createClass(InserterMenu, [{
    ...
    value: function getItems() {
      var _this$props = this.props,
          ...
          getBlockType = _this$props.getBlockType;
      ...
      return shouldAddClipboardBlock ? [_objectSpread(_objectSpread({}, pick(getBlockType(clipboardBlock.name), ['name', 'icon'])), {}, {
        id: 'clipboard',
