...
import { GlobalStylesContext, getMergedGlobalStyles, alignmentHelpers } from '@wordpress/components';
...
function BlockForType(_ref) {
  var attributes = _ref.attributes,
      ...
      onCaretVerticalPositionChange = _ref.onCaretVerticalPositionChange,
      onChange = _ref.onChange,
      onDeleteBlock = _ref.onDeleteBlock,
      onReplace = _ref.onReplace,
      parentWidth = _ref.parentWidth,
      wrapperProps = _ref.wrapperProps;
  var defaultColors = useEditorFeature('color.palette') || [];
  return createElement(GlobalStylesContext.Consumer, null, function (globalStyle) {
    var mergedStyle = getMergedGlobalStyles(globalStyle, wrapperProps.style, attributes, defaultColors);
    return createElement(GlobalStylesContext.Provider, {
      ...
      onCaretVerticalPositionChange: onCaretVerticalPositionChange // Block level styles
      ,
