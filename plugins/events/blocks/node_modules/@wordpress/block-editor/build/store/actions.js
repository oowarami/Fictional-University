  ...
  return _regenerator.default.wrap(function validateBlocksToTemplate$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _data.controls.select('core/block-editor', 'getTemplate');

        case 2:
          template = _context3.sent;
          _context3.next = 5;
          return _data.controls.select('core/block-editor', 'getTemplateLock');
        ...
        case 5:
          ...
          _context3.next = 9;
          return _data.controls.select('core/block-editor', 'isValidTemplate');
  ...
  return _regenerator.default.wrap(function multiSelect$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 2:
          _context6.next = 4;
          return _data.controls.select('core/block-editor', 'getSelectedBlockCount');
  ...
  return _regenerator.default.wrap(function synchronizeTemplate$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 2:
          _context11.next = 4;
          return _data.controls.select('core/block-editor', 'getBlocks');
    ...
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 3:
          ...
          _context12.next = 6;
          return _data.controls.select('core/block-editor', 'getBlock', clientIdA);
        ...
        case 12:
          _context12.next = 14;
          return _data.controls.select('core/block-editor', 'getBlock', clientIdB);

        case 14:
          blockB = _context12.sent;
          blockBType = (0, _blocks.getBlockType)(blockB.name);
          _context12.next = 18;
          return _data.controls.select('core/block-editor', 'getSelectionStart');
