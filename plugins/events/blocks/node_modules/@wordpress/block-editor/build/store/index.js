...
var store = (0, _data.createReduxStore)(STORE_NAME, _objectSpread(_objectSpread({}, storeConfig), {}, {
  persist: ['preferences']
})); // Ideally we'd use register instead of register stores.

exports.store = store;
(0, _data.registerStore)(STORE_NAME, _objectSpread(_objectSpread({}, storeConfig), {}, {
  persist: ['preferences']
}));
