...
exports.hasBorderRadiusSupport = hasBorderRadiusSupport;
exports.useIsBorderRadiusDisabled = useIsBorderRadiusDisabled;
...
function hasBorderRadiusSupport(blockType) {
  var support = (0, _blocks.getBlockSupport)(blockType, _border.BORDER_SUPPORT_KEY);
...
function useIsBorderRadiusDisabled() {
  ...
  var isDisabled = !(0, _useEditorFeature.default)('border.customRadius');
