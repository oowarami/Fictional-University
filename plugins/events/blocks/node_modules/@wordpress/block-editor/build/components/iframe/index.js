...
function Iframe(_ref2, ref) {
  var contentRef = _ref2.contentRef,
      ...
      head = _ref2.head,
      props = (0, _objectWithoutProperties2.default)(_ref2, ["contentRef", "children", "head"]);
  ...
  return (0, _element.createElement)("iframe", (0, _extends2.default)({}, props, {
    ref: (0, _element.useCallback)((0, _reactMergeRefs.default)([ref, setRef]), []),
    tabIndex: "0",
    title: (0, _i18n.__)('Editor canvas'),
    name: "editor-canvas"
  }), iframeDocument && (0, _element.createPortal)(children, iframeDocument.body));
}
