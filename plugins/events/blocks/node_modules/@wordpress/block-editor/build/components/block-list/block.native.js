...
function BlockForType(_ref) {
  ...
  var defaultColors = (0, _blockEditor.__experimentalUseEditorFeature)('color.palette') || [];
  return (0, _element.createElement)(_components.GlobalStylesContext.Consumer, null, function (globalStyle) {
    var mergedStyle = (0, _components.getMergedGlobalStyles)(globalStyle, wrapperProps.style, attributes, defaultColors);
