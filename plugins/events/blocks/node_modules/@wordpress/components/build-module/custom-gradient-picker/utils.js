...
import { DEFAULT_GRADIENT, INSERT_POINT_WIDTH, MINIMUM_ABSOLUTE_LEFT_POSITION, MINIMUM_DISTANCE_BETWEEN_POINTS, KEYBOARD_CONTROL_POINT_VARIATION, HORIZONTAL_GRADIENT_ORIENTATION } from './constants';
  ...
  return _objectSpread(_objectSpread({}, gradientAST), {}, {
    colorStops: gradientAST.colorStops.map(function (colorStop, colorStopIndex) {
      ...
      return _objectSpread(_objectSpread({}, colorStop), {}, {
        length: _objectSpread(_objectSpread({}, colorStop.length), {}, {
          value: relativePosition
        })
      });
    })
...
export function getGradientWithPositionAtIndexIncreased(gradientAST, index) {
  return getGradientWithPositionAtIndexSummed(gradientAST, index, KEYBOARD_CONTROL_POINT_VARIATION);
}
...
export function getGradientWithColorAtIndexChanged(gradientAST, index, rgbaColor) {
  return _objectSpread(_objectSpread({}, gradientAST), {}, {
    colorStops: gradientAST.colorStops.map(function (colorStop, colorStopIndex) {
      ...
      return _objectSpread(_objectSpread({}, colorStop), tinyColorRgbToGradientColorStop(rgbaColor));
    })
  });
}
...
function assignColorStopLengths(gradientAST) {
  var colorStops = gradientAST.colorStops;
