...
function getGradientWithPositionAtIndexIncreased(gradientAST, index) {
  return getGradientWithPositionAtIndexSummed(gradientAST, index, _constants.KEYBOARD_CONTROL_POINT_VARIATION);
}
...
function getGradientParsed(value) {
  ...
  if (gradientAST.colorStops.some(hasUnsupportedLength)) {
    ...
    gradientValue = (0, _serializer.serializeGradient)(gradientAST);
  }
