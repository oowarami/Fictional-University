...
var useConvertUnitToMobile = function useConvertUnitToMobile(value, unit) {
  ...
  var onDimensionsChange = (0, _element.useCallback)(function (_ref3) {
    var window = _ref3.window;
    setWindowSizes(window);
  }, []);
  return (0, _element.useMemo)(function () {
    var _getValueAndUnit2 = getValueAndUnit(value, unit),
        valueToConvert = _getValueAndUnit2.valueToConvert,
        valueUnit = _getValueAndUnit2.valueUnit;
