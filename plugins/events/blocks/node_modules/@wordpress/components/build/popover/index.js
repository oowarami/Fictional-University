...
function computeAnchorRect(anchorRefFallback, anchorRect, getAnchorRect) {
  ...
  if (anchorRef !== false) {
    ...
    if (typeof (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.cloneRange) === 'function') {
      return offsetIframe((0, _dom.getRectangleFromRange)(anchorRef), anchorRef.endContainer.ownerDocument);
...
var Popover = function Popover(_ref) {
  ...
  var mergedRefs = (0, _element.useCallback)((0, _reactMergeRefs.default)(allRefs), allRefs); // Event handlers
