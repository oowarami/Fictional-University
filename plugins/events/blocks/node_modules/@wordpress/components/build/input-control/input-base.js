...
function useUniqueId(idProp) {
  var instanceId = (0, _compose.useInstanceId)(InputBase);
...
function InputBase(_ref, ref) {
  var __unstableInputWidth = _ref.__unstableInputWidth,
      ...
      suffix = _ref.suffix,
      props = (0, _objectWithoutProperties2.default)(_ref, ["__unstableInputWidth", "children", "className", "disabled", "hideLabelFromVision", "labelPosition", "id", "isFocused", "label", "prefix", "size", "suffix"]);
  var id = useUniqueId(idProp);
  return (0, _element.createElement)(_inputControlStyles.Root, (0, _extends2.default)({}, props, {
    className: className,
    isFocused: isFocused,
