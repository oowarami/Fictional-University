...
function VisuallyHidden(_ref) {
  var _ref$as = _ref.as,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref, ["as", "className"]);
  return (0, _utils.renderAsRenderProps)(_objectSpread({
    as: as,
    className: (0, _classnames.default)('components-visually-hidden', className)
  }, props));
}
